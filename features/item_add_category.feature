...
Fonctionnalité: Décrire un item à l'aide d'une catégorie selon un point de vue
...
Scénario:
  ...
  Alors la catégorie "Artiste > Ateliers du Carmel du Mans" est ajoutée à l'item "ACS"
